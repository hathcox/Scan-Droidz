...
public class SinglePlayerBattleState implements State, FlickReleaseEventListener {
	...
	Texture three = new Texture(Gdx.files.internal("data/three.png"));
	Texture four = new Texture(Gdx.files.internal("data/four.png"));
	Texture five = new Texture(Gdx.files.internal("data/five.png"));
	Texture six = new Texture(Gdx.files.internal("data/six.png"));
	
	BitmapFont font = new BitmapFont(Gdx.files.internal("data/font16.fnt"),
	         Gdx.files.internal("data/font16.png"), false);

	Texture handlerOne = new Texture(Gdx.files.internal("data/handlerOne.png"));
	Texture handlerTwo = new Texture(Gdx.files.internal("data/handlerTwo.png"));
	Texture handlerThree = new Texture(Gdx.files.internal("data/handlerThree.png"));
	Texture handlerFour = new Texture(Gdx.files.internal("data/handlerFour.png"));
