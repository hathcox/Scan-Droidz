...
public class MainMenuOld implements State {
	...
	public void update(float delta) {
		...
		if(Gdx.input.justTouched()) {
			if(play.contains(currentTouch.x, currentTouch.y)) {
				...
				((TestBattleState)StateManager.getInstance().getState("TestBattleState")).setup(
				...
				StateManager.getInstance().changeState("TestBattleState");
			} 
